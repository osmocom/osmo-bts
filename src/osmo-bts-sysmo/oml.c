...
int lchan_activate(struct gsm_lchan *lchan)
{
	 ...
	 * SACCH should be activated. Also, for HO and VGCS talker detection, start the RACH SAPI. */
	if (lchan->ho.active == HANDOVER_ENABLED || rsl_chan_rt_is_vgcs(lchan->rsl_chan_rt))
