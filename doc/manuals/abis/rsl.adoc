...
This message does not conform to 3GPP TS 48.058 § 8.6.1, in that it omits the
...
|===
| TS 48.058 § | IE Name | Handling
| 9.3.21 | Resource Information | OsmoBTS omits this IE, though TS 48.058
...
This information element is coded like 3GPP TS 48.058 Section 9.3.1,
